...
$('table.photogalleryTable').replaceWith($('table.photogalleryTable').html()
   .replace(/<tbody/gi, "<div id='photogalleryTable'")
   .replace(/<tr/gi, "<div class='row collapse'")
   .replace(/<\/tr>/gi, "</div>")
   .replace(/<td class="photogalleryItem"/gi, "<div class='medium-6 large-4 columns left'")
   .replace(/<\/td>/gi, "</div>")
   .replace(/<\/tbody/gi, "<\/div")
);
//responsive poplets
$('table.productPoplets').replaceWith($('table.productPoplets').html()
   .replace(/<tbody/gi, "<div id='productPoplets'")
   .replace(/<tr/gi, "<div class='row collapse'")
   .replace(/<\/tr>/gi, "</div>")
   .replace(/<td class="productPopletsItem"/gi, "<div class='small-2 productPopletsItem columns left'")
   .replace(/<\/td>/gi, "</div>")
   .replace(/<\/tbody/gi, "<\/div")
);
